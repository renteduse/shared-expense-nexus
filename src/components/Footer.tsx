      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-4 md:mb-0">
            <Link to="/" className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-full budget-gradient flex items-center justify-center">
                <span className="font-bold text-white">BS</span>
              </div>
              <span className="font-bold text-xl text-gradient">BudgetSplit</span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground">
              Split expenses with friends and family seamlessly. Track debts, settle up, and stay organized.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {currentYear} BudgetSplit. All rights reserved.
          </p>
